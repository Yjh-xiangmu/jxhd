    ...
    <aside class="w-64 bg-[#F5F2ED] border-r border-[#EFE9E1] flex flex-col p-6 gap-6 shrink-0">
      <div class="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p class="text-[10px] text-[#A09E94] font-medium mt-1">大二班·李老师</p>
        </div>
      </div>
      ...
      <nav class="flex-1 overflow-y-auto space-y-2">
        ...
        <router-link to="/teacher" exact-active-class="bg-[#5A5A40] text-white shadow-md" class="nav-item">
        ...
        <div class="flex items-center gap-6">
          <div class="flex items-center gap-3 border-l pl-6 border-[#EFE9E1]">
            <div class="text-right">
              <p class="text-xs font-bold leading-none text-[#5A5A40]">李老师</p>
            </div>
            <div class="w-10 h-10 rounded-full bg-[#E5E0D8] border-2 border-white flex items-center justify-center text-[#A09E94] font-bold">T</div>
          </div>
        </div>
      </header>
